...
exports.exportCommentsToSrt = void 0;
const Comment_1 = require("../models/Comment");
const Projects_1 = require("../models/Projects");
const srtConverter_1 = require("../utils/srtConverter");
/**
 * @swagger
 ...
 */
const exportCommentsToSrt = async (req, res) => {
    ...
    try {
        ...
        const srtContent = (0, srtConverter_1.generateSrtContent)(comments);
        if (!srtContent) {
...
exports.exportCommentsToSrt = exportCommentsToSrt;
